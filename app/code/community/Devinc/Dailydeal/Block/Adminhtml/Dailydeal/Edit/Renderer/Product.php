...
class Devinc_Dailydeal_Block_Adminhtml_Dailydeal_Edit_Renderer_Product extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	...
	{			  
		$html = '<tr>
					...
					<td class="value"><span id="product_details_select"><a href="" onClick="document.getElementById(\'dailydeal_tabs_form_section\').removeClassName(\'active\'); document.getElementById(\'dailydeal_tabs_products_section\').addClassName(\'active\');document.getElementById(\'dailydeal_tabs_products_section_content\').style.display = \'\'; document.getElementById(\'dailydeal_tabs_form_section_content\').style.display = \'none\'; return false;">Select a Product</a></span><div style="display:none;" id="advice-required-entry-product_details_select" class="validation-advice">This is a required field.</div></td>	
				</tr>
